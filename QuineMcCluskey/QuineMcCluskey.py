...
class QuineMcV3:
    ...
    def final_step(self):
        ...
        self.final_char_min_terms = self.generate_char_min_terms(self.final_list, letters)

        self.starting_char_min_terms = self.generate_char_min_terms(self.bin_array_of_min_terms, letters)
        ...
        print(self.translated_version)



    def generate_letters(self):
        letters = []
        for i in range(self.max_number_of_digits+1):
    ...
    def translate_result(self, shortened_version):
        ...
        this_shortened_version = "+".join(shortened_version)


        return this_shortened_version